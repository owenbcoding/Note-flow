        ...
        <div className="py-16">
          <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-12 md:gap-16 lg:gap-24 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              <Link
                href="/"
                className="flex items-center space-x-2 mb-4 w-fit hover:opacity-90 transition-opacity"
              >
              ...
              <p className="text-muted-foreground mb-6 max-w-sm">
                ...
                organize, and find your thoughts effortlessly. Built for modern
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left min-w-0 w-full md:max-w-sm">
              ...
              <p className="text-muted-foreground mb-6">
                Get the latest updates, tips, and new features delivered to your
                inbox.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 w-full">
                ...
                />
                <div className="mt-2">
                  <Button className="px-8 py-5 sm:mt-0 shrink-0">
                    Subscribe
                  </Button>
                </div>
              </div>
